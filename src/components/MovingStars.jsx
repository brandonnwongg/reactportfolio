...
export const MovingStars = ({ nbParticles = 1000 }) => {
  const texture = useTexture("textures/movingstars.png");
  const particles = useMemo(
    () =>
      Array.from({ length: nbParticles }, (_, idx) => ({
        position: [randFloatSpread(15), randFloat(0, 10), randFloatSpread(15)],
...
useTexture.preload("textures/movingstars.png");
